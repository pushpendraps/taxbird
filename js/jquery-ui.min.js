      ...
      for (
        t.drawMonth = Z,
          ...
          i = K
            ? this.formatDate(
                i,
                this._daylightSavingAdjust(new Date(te, Z - J, 1)),
        ...
        for (k = "", this.maxRows = 4, C = 0; V[1] > C; C++) {
          ...
          for (
            M +=
              ...
              T +
              "'>" +
              (/all|left/.test(T) && 0 === x ? (Y ? o : s) : "") +
              (/all|right/.test(T) && 0 === x ? (Y ? s : o) : "") +
        ...
        function (e, i) {
          t.fx.step[i] = function (t) {
            (("none" !== t.end && !t.setAttr) || (1 === t.pos && !t.setAttr)) &&
              (v.style(t.elem, i, t.end), (t.setAttr = !0));
          };
        }
      ),
        t.fn.addBack ||
  ...
  t.effects.define("blind", "hide", function (e, i) {
    ...
    t.effects.define("size", function (e, i) {
      ...
      t.effects.createPlaceholder(a),
        ...
        ("box" === d || "both" === d) &&
          (n.from.y !== n.to.y &&
            ((v = t.effects.setTransition(a, h, n.from.y, v)),
            (_ = t.effects.setTransition(a, h, n.to.y, _))),
          n.from.x !== n.to.x &&
            ((v = t.effects.setTransition(a, l, n.from.x, v)),
